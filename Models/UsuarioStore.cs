...
namespace Tutorial2ManejoPresupuesto.Models
{
    ...
    {
        private readonly IUsuariosAuthService _usuariosAuthService;

        public UsuarioStore(IUsuariosAuthService usuariosAuthService)
        {
            _usuariosAuthService = usuariosAuthService;
        }
        public async Task<IdentityResult> CreateAsync(Usuario user, CancellationToken cancellationToken)
        {
            user.Id = await _usuariosAuthService.CrearUsuario(user);
        ...
        {
            return await _usuariosAuthService.GetByEmail(normalizedEmail);
        }
